...
// ================== RTC READ ==================
void bacaRTC() {
  DateTime n = RTClib::now(Wire);
  jam = (n.hour() < 10) ? "0" + String(n.hour()) : String(n.hour());
  menit = (n.minute() < 10) ? "0" + String(n.minute()) : String(n.minute());
  detik = (n.second() < 10) ? "0" + String(n.second()) : String(n.second());
  tanggal = (n.day() < 10) ? "0" + String(n.day()) : String(n.day());
}
